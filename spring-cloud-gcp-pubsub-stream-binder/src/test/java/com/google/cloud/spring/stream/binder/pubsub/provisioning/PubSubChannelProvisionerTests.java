...
public class PubSubChannelProvisionerTests {
	...
	public void testProvisionConsumerDestination_customSubscription() {
		when(this.properties.getExtension()).thenReturn(this.pubSubConsumerProperties);
		when(this.pubSubConsumerProperties.getCustomSubscription()).thenReturn("my-custom-subscription");
	...
	@Test
	public void testProvisionConsumerDestination_customSubscriptionDifferentProject() {
		when(this.properties.getExtension()).thenReturn(this.pubSubConsumerProperties);
		when(this.pubSubConsumerProperties.getCustomSubscription())
				.thenReturn("projects/differentProject/subscriptions/my-custom-subscription");
